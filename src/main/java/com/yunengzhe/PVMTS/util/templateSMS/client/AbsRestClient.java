package com.yunengzhe.PVMTS.util.templateSMS.client;
...
import com.yunengzhe.PVMTS.util.templateSMS.EncryptUtil;
import com.yunengzhe.PVMTS.util.templateSMS.SSLHttpClient;
...
public abstract class AbsRestClient {
	public boolean isTest=Boolean.parseBoolean(PropertiesUtil.getString("is_test"));
	public String server=PropertiesUtil.getString("rest_server");
	public String sslIP=PropertiesUtil.getString("http_ssl_ip");
	public int sslPort=PropertiesUtil.getInt("http_ssl_port");
	public String version=PropertiesUtil.getString("version");
