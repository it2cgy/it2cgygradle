function setup(defaultProvince, defaultCity, defaultArea) {
	addressInit("province", "city", "county",defaultProvince, defaultCity, defaultArea)
}

var initProvince = function(_cmbProvince) {
