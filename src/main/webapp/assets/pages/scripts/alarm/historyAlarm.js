...
var TableDatatablesButtons = function () {
    ...
    var initTable1 = function () {
        var table = $('#historyTable');//table id
        var oTable = table.dataTable({
           ...
           "aoColumns": [
		       ...
		       {"mDataProp":"username",
		        	 "sTitle": window.ynz.local.alarm_confirmperson,
		        	 "sClass": "center" //列对齐方式等 
		       },
		       {"mDataProp":function(obj){
		    	   return timeUtil.timeToString(obj.handTime,"yyyy-MM-dd HH:mi");
		       },
		        	 "sTitle": window.ynz.local.alarm_confirmtime,
		        	 "sClass": "center" //列对齐方式等 
		       },
		       {"mDataProp":function(obj){
		    	   var _parmsmsg = obj.id;
		    	   return "<a href='"+window.ynz.basePath+"alarmPage/affirmAlarmInfo.do?id="+ obj.id +"&powerStationId="+window.ynz.longieb.powerStationId+"';'>"+window.ynz.local.alarm_viewalarm+"</a>";
		       },
...
//	console.log(message);
//	for(var ii in echarsData){
//		if(echarsData[ii].id==message){
//			$("#messageContent").val(echarsData[ii].opreateMessage);
//		}
//	}//TODO
//}
/**
