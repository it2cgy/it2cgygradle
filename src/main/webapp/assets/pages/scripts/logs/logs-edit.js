...
//function editEqument(id){
//	if(id!=""){
//		ynzAjax.get(
//					window.ynz.path+"/pointInfo/getPowerStationEquipments/"+id+".do",  
//					function(response){ 
//						var data = response.data;
...
//							equipments.push(data[int]);
//							if(equipmentId == id){
//								$('#equipment').append("<option selected='selected' value="+id+">"+data[int].equipmentcontainerName+"</option>");
//								$('#equipment').val(id);
//							}else{
//								$('#equipment').append("<option value="+id+">"+data[int].equipmentcontainerName+"</option>");
//							}
//						}
//					},
//					function(e){ 
