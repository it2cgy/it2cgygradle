...
function saveCurve(){
	...
	if(selectData){
		...
		$("#pointSelectId").append("<tr><td>"+selectData.measurementtypeDescription+"</td><td><div style='width:30px;height: 15px;display:inline-block;background-color:"+selectData.colorCode+"' >" +
				"</div>"+" <span>"+selectData.colorCode+"</span></td>" +
						"<td>"+(selectData.yaxisType==0?window.ynz.local.curve_leftline :window.ynz.local.curve_rightline)+"</td>" +
