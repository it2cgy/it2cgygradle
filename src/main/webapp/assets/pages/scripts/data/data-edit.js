	...
	for(var iii=0;iii<selectarr.length;iii++){
		for(var i=0; i<pointsData.length; i++){
			...
			if(pointsData[i].id==selectarr[iii]){
				...
				selectData1.colorCode =getRandomColor();
      ...
      "aoColumns": [
          ...
          },
	      {
        	  "mDataProp":"",
   			 ...
   			 html+='<label class="mt-radio mt-radio-outline" style="margin:10px 10px 6px 0;">'+right+'<input type="radio" value="2" name="testRadio'+row.id+'"><span></span></label>';
   			 	 	return html;
           	  }
	       }
