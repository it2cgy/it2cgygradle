...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><i18n:message name="role_roleedit_title"/></title>
                                    ...
                                    <form action="${basePath}/user/addUser.do" id="addUserForm" method="post" class="form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="rolename" id="rolename" data-required="1" class="form-control" value="${roleInfo.roleName}" /> 
                                                	<input type="hidden" name="roleId" id="roleId" value="${roleInfo.id}">    
                                                	<input type="hidden" id="pushId" name="pushId" value="${pushMail.id }">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                  <select multiple="multiple" class="multi-select" id="my_multi_select1" name="my_multi_select1[]">
                                                	 <c:forEach items="${roleAndPower}" var="list">
                                                        	<option value="${list.powerstationId}" ${list.isChecked==1?'selected':''}>${list.powerstationName}</option>
                                                     </c:forEach>
                                                  </select>
                                                </div>
                                            </div>
                                                ...
                                                <label class="control-label col-md-3">${role_config }
                                                 ...
                                                 <div style="height:300px;overflow-y:scroll">
	                                                <c:forEach items="${menus}" var="menus">
		                                              <div class="menuRole">
		                                                	...
		                                                	<c:if test="${menus.id==27}">
		                                                		<input type="checkbox" id="premis_${menus.id}" name="premis" class="make-switch" data-on-text="&nbsp;${show}&nbsp;"  ${menus.have_menu==1?'checked':''} data-off-text="&nbsp;${hide}&nbsp;">
		                                                	</c:if>
		                                                    <c:if test="${menus.id!=27}">
		                                                		<input type="checkbox" id="premis_${menus.id}" name="premis" class="make-switch" data-on-text="&nbsp;${show}&nbsp;"  ${menus.have_menu==1?'checked':''} data-off-text="&nbsp;${hide}&nbsp;">
		                                                    	<input type="checkbox" id="handle_${menus.id}" name="handle" class="make-switch" data-on-text="&nbsp;${trueEdit}&nbsp;" ${menus.handle_premission==1?'checked':''} data-off-text="&nbsp;${falseEdit}&nbsp;">
		                                                	</c:if>
		                                                   </div>
		                                              </div>
	                                              </c:forEach>
	                                                <div class="menuRole">
		                                                	...
		                                                	<div class="col-md-9">
		                                                    	<input type="checkbox" id="pushConfirm" name="pushConfirm" class="make-switch" data-on-text="&nbsp;${show}&nbsp;"  ${pushMail.push==1?'checked':''} data-off-text="&nbsp;${hide}&nbsp;">
		                                                   </div>
		                                           </div>
                                                </div>
                                            </div>
...
<script src="${basePath}/assets/pages/scripts/role/editRole.js?version=20170817024514" type='text/javascript'></script>
