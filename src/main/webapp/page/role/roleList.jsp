...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><i18n:message name="role_rolelist_title"/> </title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a href="#"><i18n:message name="menu_rolelist"/></a>
                                <i class="fa fa-circle"></i>
                            </li>
                        </ul>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                   <c:if test="${menuConfig['12'].handle_premission!=null && menuConfig['12'].handle_premission==1}">
	                                    <div class="caption">
	                                    
	                                      <button id="addUserButton" class="btn sbold green"> <i18n:message name="menu_addrole"/>
...
<!--                                           </button> -->
		...
		<script src="${basePath}/assets/pages/scripts/role/role-list.js?version=20170817024514" type='text/javascript'></script>
