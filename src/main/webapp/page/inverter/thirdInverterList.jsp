	                  ...
	                  <%--  <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-title noBorder">                                         
                                    	<div class="col-md-12 no-padding">
                                    		<dl class="col-md-2 no-padding inverterListDl">
                                    		...
                                    		<dl class="col-md-2 no-padding inverterListDl noBorder">
...
<script src="<%=basePath %>/assets/pages/scripts/inverter/thirdInverter-list.js?version=20170817024514" type='text/javascript'></script>
