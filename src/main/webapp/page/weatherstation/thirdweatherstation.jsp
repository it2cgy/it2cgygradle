                          			...
                          			<table class="greenTable-ynz table table-bordered table-striped table-condensed flip-content" id="sample_2">
                          				...
                          				<tbody>
                          					...
                          					<tr>
                          						...
                          						<td id="inclinedExposureDaily"></td>
...
<!--                                                     </select> -->
														 ...
														 <select  multiple="multiple"   class="multi-select" id="select1" name="my_multi_select1[]">
...
<script src="${cdnPath}/global/plugins/jquery-multi-select/js/jquery.multi-select.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
<script src="${basePath}/assets/pages/scripts/weather/thirdweather.js?version=20170817024514" type='text/javascript'></script>
    </body>
