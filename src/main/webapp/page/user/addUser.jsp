...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><i18n:message name="user_useraddtitle"/></title>
                                    ...
                                    <form action="${basePath}/user/addUser.do" id="addUserForm" method="post" class="form-horizontal">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="username" id="username" data-required="1" class="form-control" value="" /> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="realname" id="realname" data-required="1" class="form-control" /> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="email" id="email" name="email" class="form-control" placeholder=""> </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input name="telephone" id="telephone" type="text" class="form-control" /> </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                 <input type="text" name="inputCompany" id="inputCompany" data-required="1" class="form-control" /> 
                                                 <select style="display:none;" class="form-control" id="companyId" name="companyId" >
...
<script src="${basePath}/assets/pages/scripts/companyuser/addUser.js?version=20170817024514" type='text/javascript'></script>
