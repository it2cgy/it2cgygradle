                                    ...
                                    <form action="#" id="form_sample_3" class="form-horizontal" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                <input type="text" id="topic" name="topic"  data-required="1" class="form-control" value="${logs.data.topic}"></input>
                                            	</div>
                                            </div>
                                            <div class="form-group">
                                           ...
                                           <!-- 按钮start -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                  <input type="text" id="kaleidoscope" name="kaleidoscope"  data-required="1" class="form-control" value="${logs.data.kaleidoscope}"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-md-3">${log_markdown} <span class="required"> * </span></label>
                                                <div class="col-md-4">
                                                    <textarea id="description" name="description" rows="8"  class="form-control">${logs.data.description}</textarea>
...
<%--         <script src="${basePath}/assets/global/plugins/bootstrap-markdown/js/bootstrap-markdown.js" type="text/javascript"></script> --%>
		...
		<script src="${basePath}/assets/pages/scripts/logs/logs-edit.js?version=20170817024514" type='text/javascript'></script>
