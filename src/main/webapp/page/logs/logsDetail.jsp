                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span class="blueFont">${alarm_viewlog}</span>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE BAR -->
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">${alarm_viewlog}</span>
                                    </div>
                                </div>
                                            	...
                                            	<div class="messageSingle">
	                                            	...
	                                            	<div class="inputList">
	                                            		...
	                                            		<div class="col-md-9 messageInfo">
		                                                     ...
		                                                     <textarea noresize id="handling" name="handling" rows="3"  class="form-control" disabled>${logs.data.handling}</textarea>
		                                                     <div id="editor_error"> </div>
		                                                </div>
	                                            	</div>
	                                            	<div class="inputList">
	                                            		...
	                                            		<div class="col-md-9 messageInfo">
		                                                     <textarea noresize id="remark" name="remark" rows="3"  class="form-control" disabled>${logs.data.remark}</textarea>
	                                                    	 <div id="editor_error"> </div>
		                                                </div>
	                                            	</div>
	                                            	<div class="inputList">
	                                            		...
	                                            		<div class="col-md-9 messageInfo">
		                                                     <input type="text" id="corporation" name="corporation" data-required="1" class="form-control" value="${logs.data.corporation}" disabled></input>
	                                                    	 <div id="editor_error"> </div>
		                                                </div>
	                                            	</div>
	                                            	<div class="inputList">
	                                            		...
	                                            		<div class="col-md-9 messageInfo">
		                                                      <input type="text" id="responsible" name="responsible" data-required="1" class="form-control" value="${logs.data.responsible}" disabled></input>
	                                                    	  <div id="editor_error"> </div>
		                                                </div>
	                                            	</div>
                                            	</div>
                                        ...
                                        <div class="form-actions noBorder">
                                            <div class="row">
                                                <div class="textCenter">
                                                	<c:if test="${logs.data.logStatus==1}">
                                                  	   <button class="btn btn-success" onclick="downloadlog(${logs.data.id})">${log_downlogrep}</button>
                                                  	   </c:if>
                                                  	   <a href="${basePath}logsPage/toLogsList.do?a=1<c:if test="${(admin!=null && admin==true) }">&admin=1</c:if><c:if test="${(powerStationId!=null && powerStationId>0) }">&powerStationId=${powerStationId}</c:if>"><button class="btn default" >${reback}</button></a> 
                                                </div>
                                            </div>
                                        </div>
                                </div>
                        ...
                        <div class="modal-dialog">
                         ...
                         <div class="form-body">  
                          <div class="form-group" style="margin-top: 20px">
                                   <label class="control-label col-md-2" style="padding:0;" >${log_category }
                                       <span class="required"> * </span>
                                   </label>
                               <div class="col-md-7">
...
<%--                                 <button type="button" class="btn green" id="save" name="save" onclick="savePoint()"><i18n:message name="add"/></button> --%>
                 ...
                 <form id="downloadForm"  method="post" action="${basePath}logsInfo/downloadlog.do">
	                 <input id="downloadForm_id" type="hidden" name="id" value="">
	                 <input id="downloadForm_powername" type="hidden" name="powername" value="">
                 </form>
            <!-- BEGIN QUICK SIDEBAR -->
...
<script src="${basePath}/assets/pages/scripts/logs/logs-detail.js?version=20170817024514" type='text/javascript'></script>
        <!-- END PAGE LEVEL SCRIPTS -->
      <script type="text/javascript">
      	var equipmentlogId = "${logs.data.equipmentId}";
      	var createTime = "${logs.data.createTime}";//$("#createTime").val();
