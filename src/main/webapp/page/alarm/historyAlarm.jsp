...
<head>
<meta charset="utf-8" />
<title><i18n:message name="menu_alarmhistory" /></title>
			...
			<div class="page-content">
				...
				<div class="page-bar">
					<ul class="page-breadcrumb">
						...
						<li><a href="#" class="blueFont"><i18n:message name="menu_alarmhistory" /></a>
					...
					<div class="col-md-12">
						...
						<div class="portlet light bordered">
							...
							<div class="portlet-body">
								<table class="table table-striped table-bordered table-hover greenTable-ynz" id="historyTable">
								</table>
							</div>
						</div>
					</div>
...
<script src="${basePath}/assets/pages/scripts/alarm/historyAlarm.js?version=20170817024514" type='text/javascript'></script>
