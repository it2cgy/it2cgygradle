...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>${alarm_alarmDisposeInfo}</title>
                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span class="blueFont">${alarm_alarmDisposeInfo}</span>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE BAR -->
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">${alarm_alarmDisposeInfo}</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    ...
                                    <form action="#" id="form_sample_3" class="form-horizontal" method="post" enctype="multipart/form-data">
                                    	<div class="form-body overflow-h">
                                            ...
                                            <div class="historyMessage">
                                            	...
                                            	<div class="inputList">
                                            		...
                                            		<div class="col-md-9 messageInfo">
	                                                     <textarea id="handling" name="handling" disabled rows="3"  class="form-control">${alarm.handling}</textarea>
                                                    	 <div id="editor_error"> </div>
	                                                </div>
                                            	</div>
                                            	<div class="inputList">
                                            		...
                                            		<div class="col-md-9 messageInfo">
	                                                     <textarea id="remaker" name="remaker" disabled rows="3"  class="form-control">${alarm.remaker}</textarea>
                                                    	 <div id="editor_error"> </div>
	                                                </div>
                                            	</div>
                                            	<div class="inputList">
                                            		...
                                            		<div class="col-md-9 messageInfo">
	                                                      <input type="text" id="corporation" disabled name="corporation" data-required="1" class="form-control" value="${alarm.corporation}"></input>
                                                    	 <div id="editor_error"> </div>
	                                                </div>
                                            	</div>
                                            </div>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <c:if test="${longiebRoleId!=4}">
                                           	   	 	<button class="btn btn-success" onclick="downloadAlarm(${alarm.id})">${alarm_downloadAlarm}</button>
                                            </c:if>
                                                   <button type="button" class="btn default" onClick="window.location.href='${basePath}alarmPage/historyAlarm.do?a=1<c:if test="${(admin!=null && admin==true) }">&admin=1</c:if>&powerStationId=${alarm.powerStationId}'" ><i18n:message name="reback" /></button>
...
<script src="${basePath}/assets/pages/scripts/alarm/alarm-dispose.js?version=20170817024514" type='text/javascript'></script>
      ...
      <script type="text/javascript">
      	$(function(){
      		setSelectMenu("menualarmmanager","alarmmanager_alarmhistory");
      	})
      </script>
    </body>
