                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <span class="blueFont">${meter_detail}</span>
                            </li>
                        </ul>
                    ...
                    <div class="row">
                          ...
                          <div class="portlet light bordered">                             
                                ...
                                <div class="caption">
                                   ...
                                   <em> ${meter_name}：<span id="name" class="caption-subject font-green bold uppercase"></span></em>
                                </div>
                                <div class="caption">
                                    <i class="icon-social-dribbble font-green"></i>
                                   <em>${meter_number}： <span id="serialNumber" class="caption-subject font-green bold uppercase"></span></em>
                                </div>
                            </div>
	                            ...
	                            <div class="portlet-body form " style='margin-top: 15px;'>
                                    ...
                                    <div class="col-sm-2 col-xs-2 col-md-1 col-lg-2 divwidth nothingBox"></div>
                                    <div style="float: left;line-height: 34px;margin-right: 40px;">
                                        <label  class="control-label">${inverter_show_data}
                                           <span class="required"> * </span>
                                       	</label> 
                                         <label class="mt-radio">
                                               <input type="radio" name="curveType" onclick='powerModel();' value="0" checked> 
                                               <%-- ${inverter_power } --%>
                                               <em id="curveType1"></em>
                                               <span></span>
                                           </label>&nbsp;&nbsp;
                                           <label class="mt-radio">
                                               <input type="radio" name="curveType" onclick='generatModel();'  value="1"> 
                                               <%-- ${meter_forward_active_energy} --%>
                                               <em id="curveType2"></em>
                                               <span></span>
                                           </label> &nbsp;&nbsp;
                                    </div> 
                              ...
                              <div class="clearfix"></div>
                                    ...
                                    <!--直流发电参数end -->
                                    <!-- 交流发电参数start -->
	                               <p id="meterAtitle" style="display:block;" class="par_title col-md-12"><i class="titleImg title_img4"></i><span>${meter_alternator_param}</span></p>
	                               <p id="meterBtitle" style="display:none;" class="par_title col-md-12"><i class="titleImg title_img4"></i><span>${meter_current_param}</span></p>
	                               <!--数据表start-->
	                               <!-- 交流参数 -->
									<div id="meterA" style="display:block;" class="ynzTable col-md-12">
									   <table class="table table-striped table-bordered table-hover noBorderTable" id="sample_1"></table>							
									</div><!--数据表end-->
									 <!-- 直流参数 -->
									<div id="meterB" style="display:none;" class="ynzTable col-md-12">
									   <table class="table table-striped table-bordered table-hover noBorderTable" id="sample_2"></table>							
									</div><!--数据表end-->
	                                <!-- 交流发电参数end --> 
...
<script src="${basePath}assets/pages/scripts/meter/meterDetail.js?version=20170817024514" type='text/javascript'></script>
